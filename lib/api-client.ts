...
export async function exportHtmlLabel(
  product: any,
  config: any,
  mode: ExportMode = 'return-zpl'
...
export const apiClient = {
  enrichProductFromDPOFE: enrichFromDPOFE,
  uploadExcel: uploadMesonExcel,
  searchProducts: searchExcel,
  getExcelStatus,
  exportHtmlLabel,
};

export type ApiProduct = ProductoPOSDPOFE;
