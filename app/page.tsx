        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-2xl font-bold text-gray-900">Etiquetas Farmacéuticas</h1>
                <p className="text-sm text-gray-500">Sistema profesional de impresión de etiquetas</p>
              </div>
            </div>
          </div>
        </div>
